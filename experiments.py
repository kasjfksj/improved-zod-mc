...
def parse_arguments():
    ...
    # Experiments to run
    p.add_argument('--eval_mmd', action='store_true',default=True)
    p.add_argument('--methods_to_run',  nargs='+')
    ...
    # Problem Specifics
    p.add_argument('--density',choices=['gmm','mueller','lmm','block_independent'])
